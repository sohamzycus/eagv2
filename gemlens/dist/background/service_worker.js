 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class g extends Error{constructor(n){super(`[GoogleGenerativeAI Error]: ${n}`)}}class Y extends g{constructor(n,t){super(n),this.response=t}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function I(e){return e.text=()=>{if(e.candidates&&e.candidates.length>0){if(e.candidates.length>1&&console.warn(`This response had ${e.candidates.length} candidates. Returning text from the first candidate only. Access response.candidates directly to use the other candidates.`),G(e.candidates[0]))throw new Y(`${T(e)}`,e);return X(e)}else if(e.promptFeedback)throw new Y(`Text not available. ${T(e)}`,e);return""},e}function X(e){var n,t,s,r;return!((r=(s=(t=(n=e.candidates)===null||n===void 0?void 0:n[0].content)===null||t===void 0?void 0:t.parts)===null||s===void 0?void 0:s[0])===null||r===void 0)&&r.text?e.candidates[0].content.parts[0].text:""}const J=[p.RECITATION,p.SAFETY];function G(e){return!!e.finishReason&&J.includes(e.finishReason)}function T(e){var n,t,s;let r="";if((!e.candidates||e.candidates.length===0)&&e.promptFeedback)r+="Response was blocked",!((n=e.promptFeedback)===null||n===void 0)&&n.blockReason&&(r+=` due to ${e.promptFeedback.blockReason}`),!((t=e.promptFeedback)===null||t===void 0)&&t.blockReasonMessage&&(r+=`: ${e.promptFeedback.blockReasonMessage}`);else if(!((s=e.candidates)===null||s===void 0)&&s[0]){const o=e.candidates[0];G(o)&&(r+=`Candidate was blocked due to ${o.finishReason}`,o.finishMessage&&(r+=`: ${o.finishMessage}`))}return r}function _(e){return this instanceof _?(this.v=e,this):new _(e)}function q(e,n,t){if(!Symbol.asyncIterator)throw new TypeError("Symbol.asyncIterator is not defined.");var s=t.apply(e,n||[]),r,o=[];return r={},c("next"),c("throw"),c("return"),r[Symbol.asyncIterator]=function(){return this},r;function c(u){s[u]&&(r[u]=function(f){return new Promise(function(A,D){o.push([u,f,A,D])>1||i(u,f)})})}function i(u,f){try{a(s[u](f))}catch(A){w(o[0][3],A)}}function a(u){u.value instanceof _?Promise.resolve(u.value.v).then(d,O):w(o[0][2],u)}function d(u){i("next",u)}function O(u){i("throw",u)}function w(u,f){u(f),o.shift(),o.length&&i(o[0][0],o[0][1])}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function x(e,n,t){const s=new y(n,m.STREAM_GENERATE_CONTENT,e,!0),r=await S(s,JSON.stringify(t));return W(r)}async function k(e,n,t){const s=new y(n,m.GENERATE_CONTENT,e,!1),o=await(await S(s,JSON.stringify(t))).json();return{response:I(o)}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function re(e,n,t){const s=new y(n,m.COUNT_TOKENS,e,!1);return(await S(s,JSON.stringify(Object.assign(Object.assign({},t),{model:n})))).json()}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function oe(e,n,t){const s=new y(n,m.EMBED_CONTENT,e,!1);return(await S(s,JSON.stringify(t))).json()}async function ie(e,n,t){const s=new y(n,m.BATCH_EMBED_CONTENTS,e,!1),r=t.requests.map(c=>Object.assign(Object.assign({},c),{model:`models/${n}`}));return(await S(s,JSON.stringify({requests:r}))).json()}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
