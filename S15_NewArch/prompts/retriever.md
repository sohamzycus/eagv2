...
### **Single-Step Mode (Simple Web Search):**
```json
{
  "result_variable_T001": [],
  "call_self": false,
...
### **RAG Mode (Local Document Search) - USE THIS FOR STORED DOCUMENTS:**
```json
{
  "rag_results_T001": "",
  "call_self": false,
  "code_variants": {
    "CODE_1A": "results = search_stored_documents_rag('DLF IPL sponsorship')\nreturn {'rag_results_T001': results}"
  }
}
```

**IMPORTANT: Use `search_stored_documents_rag` for:**
- Questions about DLF, cricket, company reports
- Any query referencing "stored documents" or "local files"
- Information that should come from uploaded PDFs, DOCX, TXT files
